...
"""
    ...
    exam_3 variable naming incorrect
    grade array missed commas
    for function missed one letter in variable grades
    last statement in if func should be else
    missed parenthesis in print() func
